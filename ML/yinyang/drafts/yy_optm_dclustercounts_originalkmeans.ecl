...
EXPORT yy_optm_dclustercounts_originalkmeans := MODULE
...
//%%%%%%%%%%% code added to v4_update
          ...
          action32 :=OUTPUT(dRolled, NAMED('YinyangKMeansv4_dRolled'));					
					...
					dCentroid2_pre:=JOIN(dJoined,dClusterCountsUpdate,LEFT.id=RIGHT.x,TRANSFORM(RECORDOF(LEFT),SELF.value:=(LEFT.value/RIGHT.y);SELF:=LEFT;), LEFT OUTER);
